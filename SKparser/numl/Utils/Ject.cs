...
namespace numl.Utils
{
    ...
    public static class Ject
    {
        ...
        public static Type FindType(string s)
        {
            ...
            Assembly InfrastructureAssembly = Assembly.LoadFrom(@"C:\Users\Domi\Documents\Visual Studio 2012\Projects\NumlSample\Infrastructure\bin\Debug\Infrastructure.dll");

            Type type = null;
            Type[] types = InfrastructureAssembly.GetTypes();
